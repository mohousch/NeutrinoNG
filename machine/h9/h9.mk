...
$(D)/kernel.do_compile: $(D)/kernel.do_prepare
	set -e; cd $(KERNEL_DIR); \
		...
		$(MAKE) -C $(KERNEL_DIR) ARCH=arm CROSS_COMPILE=$(TARGET)- $(KERNEL_DTB) $(KERNEL_IMAGE) modules
...
$(D)/kernel: $(D)/bootstrap $(D)/kernel.do_compile
	...
	cat $(KERNEL_DIR)/arch/arm/boot/$(KERNEL_IMAGE) $(KERNEL_DIR)/arch/arm/boot/dts/$(KERNEL_DTB) > $(TARGET_DIR)/boot/zImage.dtb
...
#
release-h9:
	install -m 0755 $(MACHINE_FILES)/rcS $(RELEASE_DIR)/etc/init.d/rcS
