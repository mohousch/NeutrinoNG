...
MACHINE_OPTS = --enable-ci --enable-4digits --enable-fkeys --enable-4k --enable-cec
...
BOOTARGS_SRC = zgemma-bootargs-3798mv200-$(BOOTARGS_DATE).zip

FASTBOOT_DATE = 20200916
FASTBOOT_SRC = zgemma-fastboot-3798mv200-$(FASTBOOT_DATE).zip

PARAM_DATE = 20190530
PARAM_SRC = zgemma-param-3798mv200-$(PARAM_DATE).zip
