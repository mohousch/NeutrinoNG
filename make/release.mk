...
#
	...
	echo "imageversion=0`echo "$(BS_CYCLE)" | sed 's/\./0/g'``date +%Y%m%d%H%M`" >> $(RELEASE_DIR)/.version
	...
	echo "version=0`echo "$(BS_CYCLE)" | sed 's/\./0/g'``date +%Y%m%d%H%M`" >> $(RELEASE_DIR)/.version
