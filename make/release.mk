...
#
	...
	echo "imageversion=1`echo "$(BS_CYCLE)" | sed 's/\./0/g'``date +%Y%m%d%H%M`" >> $(RELEASE_DIR)/.version
	...
	echo "version=1`echo "$(BS_CYCLE)" | sed 's/\./0/g'``date +%Y%m%d%H%M`" >> $(RELEASE_DIR)/.version
